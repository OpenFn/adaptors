...
export declare type Observation_SzClinicalObservation_Props = {
...
export default function (props: Partial<Observation_SzClinicalObservation_Props>): {
    ...
    text?: dt.Narrative;
    value?: string | number | boolean | dt.CodeableConcept | dt.Period | dt.Range | dt.Ratio | dt.Quantity | dt.SampledData;
    resourceType: string;
};
