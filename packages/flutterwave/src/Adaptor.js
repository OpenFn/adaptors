 ...
 * @typedef {Object} FlutterwaveState
 * @property data - the parsed response body from flutterwave
 * @property response - the full response from the flutterwave server, including headers, statusCode, body, etc
