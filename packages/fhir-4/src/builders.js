...
import Account_Account from "./profiles/Account";
import ActivityDefinition_ActivityDefinition from "./profiles/ActivityDefinition";
import AdministrableProductDefinition_AdministrableProductDefinition from "./profiles/AdministrableProductDefinition";
import AdverseEvent_AdverseEvent from "./profiles/AdverseEvent";
import AllergyIntolerance_AllergyIntolerance from "./profiles/AllergyIntolerance";
import Appointment_Appointment from "./profiles/Appointment";
import AppointmentResponse_AppointmentResponse from "./profiles/AppointmentResponse";
import AuditEvent_AuditEvent from "./profiles/AuditEvent";
import Basic_Basic from "./profiles/Basic";
import Binary_Binary from "./profiles/Binary";
import BiologicallyDerivedProduct_BiologicallyDerivedProduct from "./profiles/BiologicallyDerivedProduct";
import BodyStructure_BodyStructure from "./profiles/BodyStructure";
import Bundle_Bundle from "./profiles/Bundle";
import CapabilityStatement_CapabilityStatement from "./profiles/CapabilityStatement";
import CarePlan_CarePlan from "./profiles/CarePlan";
import CareTeam_CareTeam from "./profiles/CareTeam";
import CatalogEntry_CatalogEntry from "./profiles/CatalogEntry";
import ChargeItem_ChargeItem from "./profiles/ChargeItem";
import ChargeItemDefinition_ChargeItemDefinition from "./profiles/ChargeItemDefinition";
import Citation_Citation from "./profiles/Citation";
import Claim_Claim from "./profiles/Claim";
import ClaimResponse_ClaimResponse from "./profiles/ClaimResponse";
import ClinicalImpression_ClinicalImpression from "./profiles/ClinicalImpression";
import ClinicalUseDefinition_ClinicalUseDefinition from "./profiles/ClinicalUseDefinition";
import CodeSystem_CodeSystem from "./profiles/CodeSystem";
import Communication_Communication from "./profiles/Communication";
import CommunicationRequest_CommunicationRequest from "./profiles/CommunicationRequest";
import CompartmentDefinition_CompartmentDefinition from "./profiles/CompartmentDefinition";
import Composition_Composition from "./profiles/Composition";
import ConceptMap_ConceptMap from "./profiles/ConceptMap";
import Condition_Condition from "./profiles/Condition";
import Consent_Consent from "./profiles/Consent";
import Contract_Contract from "./profiles/Contract";
import Coverage_Coverage from "./profiles/Coverage";
import CoverageEligibilityRequest_CoverageEligibilityRequest from "./profiles/CoverageEligibilityRequest";
import CoverageEligibilityResponse_CoverageEligibilityResponse from "./profiles/CoverageEligibilityResponse";
import DetectedIssue_DetectedIssue from "./profiles/DetectedIssue";
import Device_Device from "./profiles/Device";
import DeviceDefinition_DeviceDefinition from "./profiles/DeviceDefinition";
import DeviceMetric_DeviceMetric from "./profiles/DeviceMetric";
import DeviceRequest_DeviceRequest from "./profiles/DeviceRequest";
import DeviceUseStatement_DeviceUseStatement from "./profiles/DeviceUseStatement";
import DiagnosticReport_DiagnosticReport from "./profiles/DiagnosticReport";
import DocumentManifest_DocumentManifest from "./profiles/DocumentManifest";
import DocumentReference_DocumentReference from "./profiles/DocumentReference";
import DomainResource_DomainResource from "./profiles/DomainResource";
import Encounter_Encounter from "./profiles/Encounter";
import Endpoint_Endpoint from "./profiles/Endpoint";
import EnrollmentRequest_EnrollmentRequest from "./profiles/EnrollmentRequest";
import EnrollmentResponse_EnrollmentResponse from "./profiles/EnrollmentResponse";
import EpisodeOfCare_EpisodeOfCare from "./profiles/EpisodeOfCare";
import EventDefinition_EventDefinition from "./profiles/EventDefinition";
import Evidence_Evidence from "./profiles/Evidence";
import EvidenceReport_EvidenceReport from "./profiles/EvidenceReport";
import EvidenceVariable_EvidenceVariable from "./profiles/EvidenceVariable";
import ExampleScenario_ExampleScenario from "./profiles/ExampleScenario";
import ExplanationOfBenefit_ExplanationOfBenefit from "./profiles/ExplanationOfBenefit";
import FamilyMemberHistory_FamilyMemberHistory from "./profiles/FamilyMemberHistory";
import Flag_Flag from "./profiles/Flag";
import Goal_Goal from "./profiles/Goal";
import GraphDefinition_GraphDefinition from "./profiles/GraphDefinition";
import Group_Group from "./profiles/Group";
import GuidanceResponse_GuidanceResponse from "./profiles/GuidanceResponse";
import HealthcareService_HealthcareService from "./profiles/HealthcareService";
import ImagingStudy_ImagingStudy from "./profiles/ImagingStudy";
import Immunization_Immunization from "./profiles/Immunization";
import ImmunizationEvaluation_ImmunizationEvaluation from "./profiles/ImmunizationEvaluation";
import ImmunizationRecommendation_ImmunizationRecommendation from "./profiles/ImmunizationRecommendation";
import ImplementationGuide_ImplementationGuide from "./profiles/ImplementationGuide";
import Ingredient_Ingredient from "./profiles/Ingredient";
import InsurancePlan_InsurancePlan from "./profiles/InsurancePlan";
import Invoice_Invoice from "./profiles/Invoice";
import Library_Library from "./profiles/Library";
import Linkage_Linkage from "./profiles/Linkage";
import List_List from "./profiles/List";
import Location_Location from "./profiles/Location";
import ManufacturedItemDefinition_ManufacturedItemDefinition from "./profiles/ManufacturedItemDefinition";
import Measure_Measure from "./profiles/Measure";
import MeasureReport_MeasureReport from "./profiles/MeasureReport";
import Media_Media from "./profiles/Media";
import Medication_Medication from "./profiles/Medication";
import MedicationAdministration_MedicationAdministration from "./profiles/MedicationAdministration";
import MedicationDispense_MedicationDispense from "./profiles/MedicationDispense";
import MedicationKnowledge_MedicationKnowledge from "./profiles/MedicationKnowledge";
import MedicationRequest_MedicationRequest from "./profiles/MedicationRequest";
import MedicationStatement_MedicationStatement from "./profiles/MedicationStatement";
import MedicinalProductDefinition_MedicinalProductDefinition from "./profiles/MedicinalProductDefinition";
import MessageDefinition_MessageDefinition from "./profiles/MessageDefinition";
import MessageHeader_MessageHeader from "./profiles/MessageHeader";
import MolecularSequence_MolecularSequence from "./profiles/MolecularSequence";
import NamingSystem_NamingSystem from "./profiles/NamingSystem";
import NutritionOrder_NutritionOrder from "./profiles/NutritionOrder";
import NutritionProduct_NutritionProduct from "./profiles/NutritionProduct";
import Observation_Observation from "./profiles/Observation";
import ObservationDefinition_ObservationDefinition from "./profiles/ObservationDefinition";
import OperationDefinition_OperationDefinition from "./profiles/OperationDefinition";
import OperationOutcome_OperationOutcome from "./profiles/OperationOutcome";
import Organization_Organization from "./profiles/Organization";
import OrganizationAffiliation_OrganizationAffiliation from "./profiles/OrganizationAffiliation";
import PackagedProductDefinition_PackagedProductDefinition from "./profiles/PackagedProductDefinition";
import Parameters_Parameters from "./profiles/Parameters";
import Patient_Patient from "./profiles/Patient";
import PaymentNotice_PaymentNotice from "./profiles/PaymentNotice";
import PaymentReconciliation_PaymentReconciliation from "./profiles/PaymentReconciliation";
import Person_Person from "./profiles/Person";
import PlanDefinition_PlanDefinition from "./profiles/PlanDefinition";
import Practitioner_Practitioner from "./profiles/Practitioner";
import PractitionerRole_PractitionerRole from "./profiles/PractitionerRole";
import Procedure_Procedure from "./profiles/Procedure";
import Provenance_Provenance from "./profiles/Provenance";
import Questionnaire_Questionnaire from "./profiles/Questionnaire";
import QuestionnaireResponse_QuestionnaireResponse from "./profiles/QuestionnaireResponse";
import RegulatedAuthorization_RegulatedAuthorization from "./profiles/RegulatedAuthorization";
import RelatedPerson_RelatedPerson from "./profiles/RelatedPerson";
import RequestGroup_RequestGroup from "./profiles/RequestGroup";
import ResearchDefinition_ResearchDefinition from "./profiles/ResearchDefinition";
import ResearchElementDefinition_ResearchElementDefinition from "./profiles/ResearchElementDefinition";
import ResearchStudy_ResearchStudy from "./profiles/ResearchStudy";
import ResearchSubject_ResearchSubject from "./profiles/ResearchSubject";
import Resource_Resource from "./profiles/Resource";
import RiskAssessment_RiskAssessment from "./profiles/RiskAssessment";
import Schedule_Schedule from "./profiles/Schedule";
import SearchParameter_SearchParameter from "./profiles/SearchParameter";
import ServiceRequest_ServiceRequest from "./profiles/ServiceRequest";
import Slot_Slot from "./profiles/Slot";
import Specimen_Specimen from "./profiles/Specimen";
import SpecimenDefinition_SpecimenDefinition from "./profiles/SpecimenDefinition";
import StructureDefinition_StructureDefinition from "./profiles/StructureDefinition";
import StructureMap_StructureMap from "./profiles/StructureMap";
import Subscription_Subscription from "./profiles/Subscription";
import SubscriptionStatus_SubscriptionStatus from "./profiles/SubscriptionStatus";
import SubscriptionTopic_SubscriptionTopic from "./profiles/SubscriptionTopic";
import Substance_Substance from "./profiles/Substance";
import SubstanceDefinition_SubstanceDefinition from "./profiles/SubstanceDefinition";
import SupplyDelivery_SupplyDelivery from "./profiles/SupplyDelivery";
import SupplyRequest_SupplyRequest from "./profiles/SupplyRequest";
import Task_Task from "./profiles/Task";
import TerminologyCapabilities_TerminologyCapabilities from "./profiles/TerminologyCapabilities";
import TestReport_TestReport from "./profiles/TestReport";
import TestScript_TestScript from "./profiles/TestScript";
import ValueSet_ValueSet from "./profiles/ValueSet";
import VerificationResult_VerificationResult from "./profiles/VerificationResult";
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.type] {Coding} - Type/identifier of event
  * @param [props.subtype] {Coding} - More specific type/id for the event
  * @param [props.action] {string} - Type of action performed during the event
  * @param [props.period] {Period} - When the activity occurred
  * @param [props.recorded] {instant} - Time when the event was recorded
  * @param [props.outcome] {string} - Whether the event succeeded or failed
  * @param [props.outcomeDesc] {string} - Description of the event outcome
  * @param [props.purposeOfEvent] {CodeableConcept} - The purposeOfUse of the event
  * @param [props.agent] {BackboneElement} - Actor involved in the event
  * @param [props.source] {BackboneElement} - Audit Event Reporter
  * @param [props.entity] {BackboneElement} - Data or objects used
 */
...
/**
  ...
  * @param [props.code] {CodeableConcept} - Kind of Resource
  * @param [props.subject] {Reference} - Identifies the focus of this resource
  * @param [props.created] {date} - When created
  * @param [props.author] {Reference} - Who created
 */
...
/**
  ...
  * @param [props.implicitRules] {string} - A set of rules under which this content was created
  * @param [props.language] {string} - Language of the resource content
  * @param [props.contentType] {string} - MimeType of the binary content
  * @param [props.securityContext] {Reference} - Identifies another resource to use as proxy when enforcing access control
  * @param [props.data] {base64Binary} - The actual content
 */
...
/**
  ...
  * @param [props.implicitRules] {string} - A set of rules under which this content was created
  * @param [props.language] {string} - Language of the resource content
  * @param [props.identifier] {Identifier} - Persistent identifier for the bundle
  * @param [props.type] {string} - document | message | transaction | transaction-response | batch | batch-response | history | searchset | collection
  * @param [props.timestamp] {instant} - When the bundle was assembled
  * @param [props.total] {unsignedInt} - If search, the total number of matches
  * @param [props.link] {BackboneElement} - Links related to this Bundle
  * @param [props.entry] {BackboneElement} - Entry in the bundle - will have a resource or information
  * @param [props.signature] {Signature} - Digital Signature
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this capability statement, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the capability statement
  * @param [props.name] {string} - Name for this capability statement (computer friendly)
  * @param [props.title] {string} - Name for this capability statement (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the capability statement
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for capability statement (if applicable)
  * @param [props.purpose] {markdown} - Why this capability statement is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.kind] {string} - instance | capability | requirements
  * @param [props.instantiates] {canonical} - Canonical URL of another capability statement this implements
  * @param [props.imports] {canonical} - Canonical URL of another capability statement this adds to
  * @param [props.software] {BackboneElement} - Software that is covered by this capability statement
  * @param [props.implementation] {BackboneElement} - If this describes a specific instance
  * @param [props.fhirVersion] {string} - FHIR Version the system supports
  * @param [props.format] {string} - formats supported (xml | json | ttl | mime type)
  * @param [props.patchFormat] {string} - Patch formats supported
  * @param [props.implementationGuide] {canonical} - Implementation guides supported
  * @param [props.rest] {BackboneElement} - If the endpoint is a RESTful one
  * @param [props.messaging] {BackboneElement} - If messaging is supported
  * @param [props.document] {BackboneElement} - Document definition
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.identifier] {Identifier} - Unique identifier of the catalog item
  * @param [props.type] {CodeableConcept} - The type of item - medication, device, service, protocol or other
  * @param [props.orderable] {boolean} - Whether the entry represents an orderable item
  * @param [props.referencedItem] {Reference} - The item that is being defined
  * @param [props.additionalIdentifier] {Identifier} - Any additional identifier(s) for the catalog item, in the same granularity or concept
  * @param [props.classification] {CodeableConcept} - Classification (category or class) of the item entry
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.validityPeriod] {Period} - The time period in which this catalog entry is expected to be active
  * @param [props.validTo] {dateTime} - The date until which this catalog entry is expected to be active
  * @param [props.lastUpdated] {dateTime} - When was this catalog last updated
  * @param [props.additionalCharacteristic] {CodeableConcept} - Additional characteristics of the catalog entry
  * @param [props.additionalClassification] {CodeableConcept} - Additional classification of the catalog entry
  * @param [props.relatedEntry] {BackboneElement} - An item that this catalog entry is related to
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this code system, represented as a URI (globally unique) (Coding.system)
  * @param [props.identifier] {Identifier} - Additional identifier for the code system (business identifier)
  * @param [props.version] {string} - Business version of the code system (Coding.version)
  * @param [props.name] {string} - Name for this code system (computer friendly)
  * @param [props.title] {string} - Name for this code system (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the code system
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for code system (if applicable)
  * @param [props.purpose] {markdown} - Why this code system is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.caseSensitive] {boolean} - If code comparison is case sensitive
  * @param [props.valueSet] {canonical} - Canonical reference to the value set with entire code system
  * @param [props.hierarchyMeaning] {string} - grouped-by | is-a | part-of | classified-with
  * @param [props.compositional] {boolean} - If code system defines a compositional grammar
  * @param [props.versionNeeded] {boolean} - If definitions are not stable
  * @param [props.content] {string} - not-present | example | fragment | complete | supplement
  * @param [props.supplements] {canonical} - Canonical URL of Code System this adds designations and properties to
  * @param [props.count] {unsignedInt} - Total concepts in the code system
  * @param [props.filter] {BackboneElement} - Filter that can be used in a value set
  * @param [props.property] {BackboneElement} - Additional information supplied about each concept
  * @param [props.concept] {BackboneElement} - Concepts in the code system
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this compartment definition, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the compartment definition
  * @param [props.name] {string} - Name for this compartment definition (computer friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the compartment definition
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.purpose] {markdown} - Why this compartment definition is defined
  * @param [props.code] {string} - Patient | Encounter | RelatedPerson | Practitioner | Device
  * @param [props.search] {boolean} - Whether the search syntax is supported
  * @param [props.resource] {BackboneElement} - How a resource is related to the compartment
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.identifier] {Identifier} - Version-independent identifier for the Composition
  * @param [props.status] {string} - preliminary | final | amended | entered-in-error
  * @param [props.type] {CodeableConcept} - Kind of composition (LOINC if possible)
  * @param [props.category] {CodeableConcept} - Categorization of Composition
  * @param [props.subject] {Reference} - Who and/or what the composition is about
  * @param [props.encounter] {Reference} - Context of the Composition
  * @param [props.date] {dateTime} - Composition editing time
  * @param [props.author] {Reference} - Who and/or what authored the composition
  * @param [props.title] {string} - Human Readable name/title
  * @param [props.confidentiality] {string} - As defined by affinity domain
  * @param [props.attester] {BackboneElement} - Attests to accuracy of composition
  * @param [props.custodian] {Reference} - Organization which maintains the composition
  * @param [props.relatesTo] {BackboneElement} - Relationships to other compositions/documents
  * @param [props.event] {BackboneElement} - The clinical service(s) being documented
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this concept map, represented as a URI (globally unique)
  * @param [props.identifier] {Identifier} - Additional identifier for the concept map
  * @param [props.version] {string} - Business version of the concept map
  * @param [props.name] {string} - Name for this concept map (computer friendly)
  * @param [props.title] {string} - Name for this concept map (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the concept map
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for concept map (if applicable)
  * @param [props.purpose] {markdown} - Why this concept map is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.source] {string} - The source value set that contains the concepts that are being mapped
  * @param [props.target] {string} - The target value set which provides context for the mappings
  * @param [props.group] {BackboneElement} - Same source and target systems
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.identifier] {Identifier} - Identifier for this record (external references)
  * @param [props.status] {string} - draft | proposed | active | rejected | inactive | entered-in-error
  * @param [props.scope] {CodeableConcept} - Which of the four areas this resource covers (extensible)
  * @param [props.category] {CodeableConcept} - Classification of the consent statement - for indexing/retrieval
  * @param [props.patient] {Reference} - Who the consent applies to
  * @param [props.dateTime] {dateTime} - When this Consent was created or indexed
  * @param [props.performer] {Reference} - Who is agreeing to the policy and rules
  * @param [props.organization] {Reference} - Custodian of the consent
  * @param [props.source] {Attachment} - Source from which this consent is taken
  * @param [props.policy] {BackboneElement} - Policies covered by this consent
  * @param [props.policyRule] {CodeableConcept} - Regulation that this consents to
  * @param [props.verification] {BackboneElement} - Consent Verified by patient or family
  * @param [props.provision] {BackboneElement} - Constraints to the base Consent.policyRule
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.masterIdentifier] {Identifier} - Unique Identifier for the set of documents
  * @param [props.identifier] {Identifier} - Other identifiers for the manifest
  * @param [props.status] {string} - current | superseded | entered-in-error
  * @param [props.type] {CodeableConcept} - Kind of document set
  * @param [props.subject] {Reference} - The subject of the set of documents
  * @param [props.created] {dateTime} - When this document manifest created
  * @param [props.author] {Reference} - Who and/or what authored the DocumentManifest
  * @param [props.recipient] {Reference} - Intended to get notified about this set of documents
  * @param [props.source] {string} - The source system/application/software
  * @param [props.description] {string} - Human-readable description (title)
  * @param [props.content] {Reference} - Items in manifest
  * @param [props.related] {BackboneElement} - Related things
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.masterIdentifier] {Identifier} - Master Version Specific Identifier
  * @param [props.identifier] {Identifier} - Other identifiers for the document
  * @param [props.status] {string} - current | superseded | entered-in-error
  * @param [props.docStatus] {string} - preliminary | final | amended | entered-in-error
  * @param [props.type] {CodeableConcept} - Kind of document (LOINC if possible)
  * @param [props.category] {CodeableConcept} - Categorization of document
  * @param [props.subject] {Reference} - Who/what is the subject of the document
  * @param [props.date] {instant} - When this document reference was created
  * @param [props.author] {Reference} - Who and/or what authored the document
  * @param [props.authenticator] {Reference} - Who/what authenticated the document
  * @param [props.custodian] {Reference} - Organization which maintains the document
  * @param [props.relatesTo] {BackboneElement} - Relationships to other documents
  * @param [props.description] {string} - Human-readable description
  * @param [props.securityLabel] {CodeableConcept} - Document security-tags
  * @param [props.content] {BackboneElement} - Document referenced
  * @param [props.context] {BackboneElement} - Clinical context of document
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this example scenario, represented as a URI (globally unique)
  * @param [props.identifier] {Identifier} - Additional identifier for the example scenario
  * @param [props.version] {string} - Business version of the example scenario
  * @param [props.name] {string} - Name for this example scenario (computer friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for example scenario (if applicable)
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.purpose] {markdown} - The purpose of the example, e.g. to illustrate a scenario
  * @param [props.actor] {BackboneElement} - Actor participating in the resource
  * @param [props.instance] {BackboneElement} - Each resource and each version that is present in the workflow
  * @param [props.process] {BackboneElement} - Each major process - a group of operations
  * @param [props.workflow] {canonical} - Another nested workflow
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this graph definition, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the graph definition
  * @param [props.name] {string} - Name for this graph definition (computer friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the graph definition
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for graph definition (if applicable)
  * @param [props.purpose] {markdown} - Why this graph definition is defined
  * @param [props.start] {string} - Type of resource at which the graph starts
  * @param [props.profile] {canonical} - Profile on base resource
  * @param [props.link] {BackboneElement} - Links this graph makes rules about
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this implementation guide, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the implementation guide
  * @param [props.name] {string} - Name for this implementation guide (computer friendly)
  * @param [props.title] {string} - Name for this implementation guide (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the implementation guide
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for implementation guide (if applicable)
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.packageId] {id} - NPM Package name for IG
  * @param [props.license] {string} - SPDX license code for this IG (or not-open-source)
  * @param [props.fhirVersion] {string} - FHIR Version(s) this Implementation Guide targets
  * @param [props.dependsOn] {BackboneElement} - Another Implementation guide this depends on
  * @param [props.global] {BackboneElement} - Profiles that apply globally
  * @param [props.definition] {BackboneElement} - Information needed to build the IG
  * @param [props.manifest] {BackboneElement} - Information about an assembled IG
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.active] {boolean} - Whether this linkage assertion is active or not
  * @param [props.author] {Reference} - Who is responsible for linkages
  * @param [props.item] {BackboneElement} - Item to be linked
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Business Identifier for a given MessageDefinition
  * @param [props.identifier] {Identifier} - Primary key for the message definition on a given server
  * @param [props.version] {string} - Business version of the message definition
  * @param [props.name] {string} - Name for this message definition (computer friendly)
  * @param [props.title] {string} - Name for this message definition (human friendly)
  * @param [props.replaces] {canonical} - Takes the place of
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the message definition
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for message definition (if applicable)
  * @param [props.purpose] {markdown} - Why this message definition is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.base] {canonical} - Definition this one is based on
  * @param [props.parent] {canonical} - Protocol/workflow this is part of
  * @param [props.event] {Coding} - Event code  or link to the EventDefinition
  * @param [props.category] {string} - consequence | currency | notification
  * @param [props.focus] {BackboneElement} - Resource(s) that are the subject of the event
  * @param [props.responseRequired] {string} - always | on-error | never | on-success
  * @param [props.allowedResponse] {BackboneElement} - Responses to this message
  * @param [props.graph] {canonical} - Canonical reference to a GraphDefinition
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.event] {Coding} - Code for the event this message represents or link to event definition
  * @param [props.destination] {BackboneElement} - Message destination application(s)
  * @param [props.sender] {Reference} - Real world sender of the message
  * @param [props.enterer] {Reference} - The source of the data entry
  * @param [props.author] {Reference} - The source of the decision
  * @param [props.source] {BackboneElement} - Message source application
  * @param [props.responsible] {Reference} - Final responsibility for event
  * @param [props.reason] {CodeableConcept} - Cause of event
  * @param [props.response] {BackboneElement} - If this is a reply to prior message
  * @param [props.focus] {Reference} - The actual content of the message
  * @param [props.definition] {canonical} - Link to the definition for this message
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.name] {string} - Name for this naming system (computer friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.kind] {string} - codesystem | identifier | root
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.responsible] {string} - Who maintains system namespace?
  * @param [props.type] {CodeableConcept} - e.g. driver,  provider,  patient, bank etc.
  * @param [props.description] {markdown} - Natural language description of the naming system
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for naming system (if applicable)
  * @param [props.usage] {string} - How/where is it used
  * @param [props.uniqueId] {BackboneElement} - Unique identifiers used for system
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this operation definition, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the operation definition
  * @param [props.name] {string} - Name for this operation definition (computer friendly)
  * @param [props.title] {string} - Name for this operation definition (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.kind] {string} - operation | query
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the operation definition
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for operation definition (if applicable)
  * @param [props.purpose] {markdown} - Why this operation definition is defined
  * @param [props.affectsState] {boolean} - Whether content is changed by the operation
  * @param [props.code] {string} - Name used to invoke the operation
  * @param [props.comment] {markdown} - Additional information about use
  * @param [props.base] {canonical} - Marks this as a profile of the base
  * @param [props.resource] {string} - Types this operation applies to
  * @param [props.system] {boolean} - Invoke at the system level?
  * @param [props.type] {boolean} - Invoke at the type level?
  * @param [props.instance] {boolean} - Invoke on an instance?
  * @param [props.inputProfile] {canonical} - Validation information for in parameters
  * @param [props.outputProfile] {canonical} - Validation information for out parameters
  * @param [props.parameter] {BackboneElement} - Parameters for the operation/query
  * @param [props.overload] {BackboneElement} - Define overloaded variants for when  generating code
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.issue] {BackboneElement} - A single issue associated with the action
 */
...
/**
  ...
  * @param [props.implicitRules] {string} - A set of rules under which this content was created
  * @param [props.language] {string} - Language of the resource content
  * @param [props.parameter] {BackboneElement} - Operation Parameter
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.target] {Reference} - Target Reference(s) (usually version specific)
  * @param [props.occurred] {Period} - When the activity occurred
  * @param [props.recorded] {instant} - When the activity was recorded / updated
  * @param [props.policy] {string} - Policy or plan the activity was defined by
  * @param [props.location] {Reference} - Where the activity occurred, if relevant
  * @param [props.reason] {CodeableConcept} - Reason the activity is occurring
  * @param [props.activity] {CodeableConcept} - Activity that occurred
  * @param [props.agent] {BackboneElement} - Actor involved
  * @param [props.entity] {BackboneElement} - An entity used in this activity
  * @param [props.signature] {Signature} - Signature on target
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this search parameter, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the search parameter
  * @param [props.name] {string} - Name for this search parameter (computer friendly)
  * @param [props.derivedFrom] {canonical} - Original definition for the search parameter
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the search parameter
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for search parameter (if applicable)
  * @param [props.purpose] {markdown} - Why this search parameter is defined
  * @param [props.code] {string} - Code used in URL
  * @param [props.base] {string} - The resource type(s) this search parameter applies to
  * @param [props.type] {string} - number | date | string | token | reference | composite | quantity | uri | special
  * @param [props.expression] {string} - FHIRPath expression that extracts the values
  * @param [props.xpath] {string} - XPath that extracts the values
  * @param [props.xpathUsage] {string} - normal | phonetic | nearby | distance | other
  * @param [props.target] {string} - Types of resource (if a resource reference)
  * @param [props.multipleOr] {boolean} - Allow multiple values per parameter (or)
  * @param [props.multipleAnd] {boolean} - Allow multiple parameters (and)
  * @param [props.comparator] {string} - eq | ne | gt | lt | ge | le | sa | eb | ap
  * @param [props.modifier] {string} - missing | exact | contains | not | text | in | not-in | below | above | type | identifier | ofType
  * @param [props.chain] {string} - Chained names supported
  * @param [props.component] {BackboneElement} - For Composite resources to define the parts
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this structure definition, represented as a URI (globally unique)
  * @param [props.identifier] {Identifier} - Additional identifier for the structure definition
  * @param [props.version] {string} - Business version of the structure definition
  * @param [props.name] {string} - Name for this structure definition (computer friendly)
  * @param [props.title] {string} - Name for this structure definition (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the structure definition
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for structure definition (if applicable)
  * @param [props.purpose] {markdown} - Why this structure definition is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.keyword] {Coding} - Assist with indexing and finding
  * @param [props.fhirVersion] {string} - FHIR Version this StructureDefinition targets
  * @param [props.mapping] {BackboneElement} - External specification that the content is mapped to
  * @param [props.kind] {string} - primitive-type | complex-type | resource | logical
  * @param [props.abstract] {boolean} - Whether the structure is abstract
  * @param [props.context] {BackboneElement} - If an extension, where it can be used in instances
  * @param [props.contextInvariant] {string} - FHIRPath invariants - when the extension can be used
  * @param [props.type] {string} - Type defined or constrained by this structure
  * @param [props.baseDefinition] {canonical} - Definition that this type is constrained/specialized from
  * @param [props.derivation] {string} - specialization | constraint - How relates to base definition
  * @param [props.snapshot] {BackboneElement} - Snapshot view of the structure
  * @param [props.differential] {BackboneElement} - Differential view of the structure
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this structure map, represented as a URI (globally unique)
  * @param [props.identifier] {Identifier} - Additional identifier for the structure map
  * @param [props.version] {string} - Business version of the structure map
  * @param [props.name] {string} - Name for this structure map (computer friendly)
  * @param [props.title] {string} - Name for this structure map (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the structure map
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for structure map (if applicable)
  * @param [props.purpose] {markdown} - Why this structure map is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.structure] {BackboneElement} - Structure Definition used by this map
  * @param [props.import] {canonical} - Other maps used by this map (canonical URLs)
  * @param [props.group] {BackboneElement} - Named sections for reader convenience
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.status] {string} - requested | active | error | off
  * @param [props.contact] {ContactPoint} - Contact details for source (e.g. troubleshooting)
  * @param [props.end] {instant} - When to automatically delete the subscription
  * @param [props.reason] {string} - Description of why this subscription was created
  * @param [props.criteria] {string} - Rule for server push
  * @param [props.error] {string} - Latest error note
  * @param [props.channel] {BackboneElement} - The channel on which to report matches to the criteria
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.status] {string} - requested | active | error | off | entered-in-error
  * @param [props.type] {string} - handshake | heartbeat | event-notification | query-status | query-event
  * @param [props.eventsSinceSubscriptionStart] {string} - Events since the Subscription was created
  * @param [props.notificationEvent] {BackboneElement} - Detailed information about any events relevant to this notification
  * @param [props.subscription] {Reference} - Reference to the Subscription responsible for this notification
  * @param [props.topic] {canonical} - Reference to the SubscriptionTopic this notification relates to
  * @param [props.error] {CodeableConcept} - List of errors on the subscription
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this subscription topic definition, represented as a URI (globally unique)
  * @param [props.identifier] {Identifier} - Business Identifier for this subscription topic
  * @param [props.version] {string} - Business version of the subscription topic
  * @param [props.title] {string} - Name for this subscription topic (Human friendly)
  * @param [props.derivedFrom] {canonical} - Based on FHIR protocol or definition
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - If for testing purposes, not real usage
  * @param [props.date] {dateTime} - Date status first applied
  * @param [props.publisher] {string} - The name of the individual or organization that published the SubscriptionTopic
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the SubscriptionTopic
  * @param [props.useContext] {UsageContext} - Content intends to support these contexts
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction of the SubscriptionTopic (if applicable)
  * @param [props.purpose] {markdown} - Why this SubscriptionTopic is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.approvalDate] {date} - When SubscriptionTopic is/was approved by publisher
  * @param [props.lastReviewDate] {date} - Date the Subscription Topic was last reviewed by the publisher
  * @param [props.effectivePeriod] {Period} - The effective date range for the SubscriptionTopic
  * @param [props.resourceTrigger] {BackboneElement} - Definition of a resource-based trigger for the subscription topic
  * @param [props.eventTrigger] {BackboneElement} - Event definitions the SubscriptionTopic
  * @param [props.canFilterBy] {BackboneElement} - Properties by which a Subscription can filter notifications from the SubscriptionTopic
  * @param [props.notificationShape] {BackboneElement} - Properties for describing the shape of notifications generated by this topic
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this terminology capabilities, represented as a URI (globally unique)
  * @param [props.version] {string} - Business version of the terminology capabilities
  * @param [props.name] {string} - Name for this terminology capabilities (computer friendly)
  * @param [props.title] {string} - Name for this terminology capabilities (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the terminology capabilities
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for terminology capabilities (if applicable)
  * @param [props.purpose] {markdown} - Why this terminology capabilities is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.kind] {string} - instance | capability | requirements
  * @param [props.software] {BackboneElement} - Software that is covered by this terminology capability statement
  * @param [props.implementation] {BackboneElement} - If this describes a specific instance
  * @param [props.lockedDate] {boolean} - Whether lockedDate is supported
  * @param [props.codeSystem] {BackboneElement} - A code system supported by the server
  * @param [props.expansion] {BackboneElement} - Information about the [ValueSet/$expand](valueset-operation-expand.html) operation
  * @param [props.codeSearch] {string} - explicit | all
  * @param [props.validateCode] {BackboneElement} - Information about the [ValueSet/$validate-code](valueset-operation-validate-code.html) operation
  * @param [props.translation] {BackboneElement} - Information about the [ConceptMap/$translate](conceptmap-operation-translate.html) operation
  * @param [props.closure] {BackboneElement} - Information about the [ConceptMap/$closure](conceptmap-operation-closure.html) operation
 */
...
/**
  ...
  * @param [props.extension] {Extension} - Additional content defined by implementations
  * @param [props.modifierExtension] {Extension} - Extensions that cannot be ignored
  * @param [props.url] {string} - Canonical identifier for this value set, represented as a URI (globally unique)
  * @param [props.identifier] {Identifier} - Additional identifier for the value set (business identifier)
  * @param [props.version] {string} - Business version of the value set
  * @param [props.name] {string} - Name for this value set (computer friendly)
  * @param [props.title] {string} - Name for this value set (human friendly)
  * @param [props.status] {string} - draft | active | retired | unknown
  * @param [props.experimental] {boolean} - For testing purposes, not real usage
  * @param [props.date] {dateTime} - Date last changed
  * @param [props.publisher] {string} - Name of the publisher (organization or individual)
  * @param [props.contact] {ContactDetail} - Contact details for the publisher
  * @param [props.description] {markdown} - Natural language description of the value set
  * @param [props.useContext] {UsageContext} - The context that the content is intended to support
  * @param [props.jurisdiction] {CodeableConcept} - Intended jurisdiction for value set (if applicable)
  * @param [props.immutable] {boolean} - Indicates whether or not any change to the content logical definition may occur
  * @param [props.purpose] {markdown} - Why this value set is defined
  * @param [props.copyright] {markdown} - Use and/or publishing restrictions
  * @param [props.compose] {BackboneElement} - Content logical definition of the value set (CLD)
  * @param [props.expansion] {BackboneElement} - Used when the value set is "expanded"
 */
