...
// import { handleResponse, sendRequest } from './Utils';
...
//       ...resolvedData,
//     };
//     return sendRequest(url, options, 'POST').then(({ response, data }) =>
...
//     return sendRequest(url, options, 'POST').then(({ data }) =>
//       callback({ ...state, data })
//     );
//   };
// }
...
//     return sendRequest(url, { ...resolvedQuery }).then(({ response, data }) =>
//       handleResponse(response, data, state, callback)
//     );
//   };
// }
