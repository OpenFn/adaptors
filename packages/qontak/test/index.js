import { execute, get, post, put, patch, del, alterState, request, convertToCSVString } from '../src';
...
describe('test convertToCSVString', () => {
  it('convert dummy data to CSV', async () => {
    const state = {
      configuration: {},
      data: { rows: [{ name: "Alice", age: 22 }, { name: "Bob", age: 24 }] },
    };
