 ...
 * @function
 * @public
 * @param {object} body - Credential issuance payload containing credential, credentialSchemaId, credentialSchemaVersion, and tags
 * @param {RequestOptions} options - Optional request options
 * @returns {Operation}
 * @state {HttpState}
 */
export function issueCredential(body, options) {
  return request('POST', '/credentials/issue', body, options);
}
