...
/**
 * Make a PUT request to OpenFn API. Requires authentication first.
 * @public
 * @example <caption>PUT update a job</caption>
 * put('jobs/123', {
 *   name: 'updated job',
 *   body: 'fn(state => ({ ...state, updated: true }))'
 * });
 * @example <caption>PUT with custom headers</caption>
 * put('jobs/123', {
 *   name: 'updated job'
 * }, {
 *   headers: { 'x-custom': 'value' },
...
/**
 * Make a PATCH request to OpenFn API. Requires authentication first.
 * @public
 * @example <caption>PATCH partial update a job</caption>
 * patch('jobs/123', {
 *   name: 'partially updated job'
 * });
 * @example <caption>PATCH with custom headers</caption>
 * patch('jobs/123', {
 *   name: 'partially updated job'
 * }, {
 *   headers: { 'x-custom': 'value' },
...
/**
 * Make a DELETE request to OpenFn API. Requires authentication first.
 * @public
 * @example <caption>DELETE a job</caption>
 * del('jobs/123');
 * @example <caption>DELETE with custom headers</caption>
 * del('jobs/123', {
 *   headers: { 'x-custom': 'value' },
 * });
 * @function
