...
| [props.class] | <code>string</code> | Department in which the encounter took place. Accepts values: OPD, IPD, CO, SO |
...
| [props.operationalStatus] | <code>string</code> | The operational status of the location (typically only for a bed/room) |
