...
<dl>
<dt>
    <a href="#">create(resourceType, data, [callback])</a></dt>
<dt>
    <a href="#">createEncounter(data, [callback])</a></dt>
<dt>
    <a href="#">createPatient(data, [callback])</a></dt>
<dt>
    <a href="#">get(path, query, [callback])</a></dt>
<dt>
    <a href="#">getEncounter(uuid, [callback])</a></dt>
<dt>
    <a href="#">getEncounters(query, [callback])</a></dt>
<dt>
    <a href="#">getPatient(uuid, [callback])</a></dt>
<dt>
    <a href="#">post(path, data, [callback])</a></dt>
<dt>
    <a href="#">searchPatient(query, [callback])</a></dt>
<dt>
    <a href="#">searchPerson(query, [callback])</a></dt>
<dt>
    <a href="#">update(resourceType, path, data, [callback])</a></dt>
<dt>
    <a href="#">upsert(resourceType, query, data, [callback])</a></dt>
</dl>
