...
<dt>
    <a href="#">createCase(params, callback)</a></dt>
<dt>
    <a href="#">createReferrals(params, callback)</a></dt>
<dt>
    <a href="#">generateAuthString(state)</a></dt>
<dt>
    <a href="#">getCases(query, options, callback)</a></dt>
<dt>
    <a href="#">getForms(query, callback)</a></dt>
<dt>
    <a href="#">getLocations(query, callback)</a></dt>
<dt>
    <a href="#">getLookups(query, callback)</a></dt>
<dt>
    <a href="#">getReferrals(params, callback)</a></dt>
<dt>
    <a href="#">login(state)</a></dt>
<dt>
    <a href="#">queryHandler(state, params, callback)</a></dt>
<dt>
    <a href="#">updateCase(id, params, callback)</a></dt>
<dt>
    <a href="#">updateReferral(params, callback)</a></dt>
<dt>
    <a href="#">upsertCase(params, callback)</a></dt>
</dl>
